...
Wine.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new Wine.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
Wine.TabelaClientePesquisaRapida = (function() {
...
$(function() {
	var pesquisaRapidaCliente = new Wine.PesquisaRapidaCliente();
